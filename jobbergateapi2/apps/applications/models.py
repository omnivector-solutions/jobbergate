...
applications_table = Table(
    ...
    Column("identifier", String, nullable=True, unique=True),
    Column("application_name", String, nullable=False, index=True, unique=False),
    Column("application_description", String, default=""),
    Column("application_owner_id", ForeignKey("users.id")),
