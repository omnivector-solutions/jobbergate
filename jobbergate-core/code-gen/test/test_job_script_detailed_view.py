...
from openapi_client.models.job_script_detailed_view import JobScriptDetailedView  # noqa: E501

class TestJobScriptDetailedView(unittest.TestCase):
    """JobScriptDetailedView unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobScriptDetailedView:
        """Test JobScriptDetailedView
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobScriptDetailedView`
        """
        model = JobScriptDetailedView()  # noqa: E501
        if include_optional:
            return JobScriptDetailedView(
                id = 101,
    ...
    def testJobScriptDetailedView(self):
        """Test JobScriptDetailedView"""
