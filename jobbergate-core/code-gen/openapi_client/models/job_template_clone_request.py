...
class JobTemplateCloneRequest(BaseModel):
    """
    Schema for the request to clone a job template.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JobTemplateCloneRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JobTemplateCloneRequest:
        """Create an instance of JobTemplateCloneRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JobTemplateCloneRequest.parse_obj(obj)

        _obj = JobTemplateCloneRequest.parse_obj({
            "name": obj.get("name"),
