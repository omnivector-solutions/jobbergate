...
class JobScriptListView(BaseModel):
    """
    ...
    __properties = ["id", "name", "owner_email", "created_at", "updated_at", "is_archived", "description", "parent_template_id", "template", "cloned_from_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JobScriptListView:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JobScriptListView:
        """Create an instance of JobScriptListView from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JobScriptListView.parse_obj(obj)

        _obj = JobScriptListView.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
