...
class TemplateFileDetailedView(BaseModel):
    """
    Schema for the response to get a template file.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TemplateFileDetailedView:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TemplateFileDetailedView:
        """Create an instance of TemplateFileDetailedView from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TemplateFileDetailedView.parse_obj(obj)

        _obj = TemplateFileDetailedView.parse_obj({
