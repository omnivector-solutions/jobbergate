...
class JobScriptCloneRequest(BaseModel):
    """
    Request model for cloning JobScript instances.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JobScriptCloneRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JobScriptCloneRequest:
        """Create an instance of JobScriptCloneRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JobScriptCloneRequest.parse_obj(obj)

        _obj = JobScriptCloneRequest.parse_obj({
            "name": obj.get("name"),
