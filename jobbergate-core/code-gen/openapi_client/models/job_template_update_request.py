...
class JobTemplateUpdateRequest(BaseModel):
    """
    Schema for the request to update a job template.  # noqa: E501
    """
    name: Optional[StrictStr] = Field(None, description="The unique name of the instance")
    ...
    is_archived: Optional[StrictBool] = Field(None, description="Indicates if the job script template has been archived.")
    __properties = ["name", "identifier", "description", "template_vars", "is_archived"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JobTemplateUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JobTemplateUpdateRequest:
        """Create an instance of JobTemplateUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JobTemplateUpdateRequest.parse_obj(obj)

        _obj = JobTemplateUpdateRequest.parse_obj({
            "name": obj.get("name"),
