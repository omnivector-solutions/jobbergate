...
class JobScriptFiles:
    ...
    @validate_call
    def upsert(self, id: int, file_type: FileType, file_path: Path) -> JobScriptFileDetailedView:
        """
        ...
        return response.raise_for_status().check_status_code(200).to_model(JobScriptFileDetailedView)

    @validate_call
    def delete(self, id: int, filename: str) -> None:
        """
    ...
    @validate_call
    def download(self, id: int, filename: str, directory: Path = Path.cwd()) -> Path:
        """
