...
async def test_create_job_submission__with_cluster_id_in_token(
    ...
    inject_security_header(
        "owner1@org.com", Permissions.JOB_SUBMISSIONS_EDIT, cluster_id="dummy-cluster-client",
    )
...
async def test_job_submissions_agent_pending__success(
    ...
    inject_security_header(
        "who@cares.com", Permissions.JOB_SUBMISSIONS_VIEW, cluster_id="dummy-client",
    )
...
async def test_job_submissions_agent_update__success(
    ...
    inject_security_header(
        "who@cares.com", Permissions.JOB_SUBMISSIONS_EDIT, cluster_id="dummy-client",
    )
    response = await client.put(
