...
def test_job_submission_string_conversion(job_submission_data):
    ...
    """
    job_submission = JobSubmission(job_submission_owner_email=1, **job_submission_data)
...
def test_create_job_submission(job_submission_data):
    ...
    job_submission = JobSubmission(
        job_submission_owner_email="owner1@org.com", created_at=datetime.utcnow(), **job_submission_data
    )
