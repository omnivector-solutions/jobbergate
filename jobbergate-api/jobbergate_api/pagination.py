...
from typing import Generic, List, Optional, TypeVar, Dict, Type, Union
...
def ok_response(response_model: Type[TResponseModel]) -> Dict[Union[int, str], Dict[str, Type[Response[TResponseModel]]]]:
    """
    ...
    return {200: {"model": Response[response_model]}}
