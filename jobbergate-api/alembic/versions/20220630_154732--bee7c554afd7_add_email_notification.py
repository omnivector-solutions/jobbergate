...
new_status_list = old_status_list + ["REJECTED"]
...
def downgrade():
    ...
    # Convert 'REJECTED' status into 'UNKNOWN'
    op.execute("UPDATE job_submissions SET status = 'UNKNOWN' WHERE status = 'REJECTED'")
