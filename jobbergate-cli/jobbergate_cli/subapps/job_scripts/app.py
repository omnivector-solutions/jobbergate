...
def update(
    ...
    id: int = typer.Option(
        ...,
        help=f"The id of the job script to update",
    ),
    ...
    job_script_result = typing.cast(
        ...
        make_request(
            ...
            "PUT",
            expected_status=202,
            abort_message=f"Couldn't update job script",
            support=True,
...
def delete(
    ...
    id: int = typer.Option(
        ...,
        help=f"The id of the job script to delete",
    ),
):
    """
    ...
    make_request(
        ...
        "DELETE",
        expected_status=204,
        abort_message=f"Rquest to delete job script was not accepted by the API",
        support=True,
    )
    terminal_message(
