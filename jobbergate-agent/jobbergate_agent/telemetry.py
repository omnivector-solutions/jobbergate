"""OpenTelemetry instrumentation for Jobbergate Agent.

This module initializes and configures OpenTelemetry tracing and metrics
for the background job agent, working alongside Sentry SDK for dual export.
"""
...
from jobbergate_agent.settings import JobbergateAgentSettings

_tracer_provider: TracerProvider | None = None
_tracer: trace.Tracer | None = None


def init_telemetry(settings: JobbergateAgentSettings) -> None:
    ...
    Args:
        settings: JobbergateAgentSettings instance with OTLP configuration.
    """
